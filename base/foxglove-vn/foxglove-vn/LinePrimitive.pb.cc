...
static ::_pb::Metadata file_level_metadata_LinePrimitive_2eproto[1];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_LinePrimitive_2eproto[1];
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_LinePrimitive_2eproto = nullptr;

const uint32_t TableStruct_LinePrimitive_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_LinePrimitive_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\023LinePrimitive.proto\022\010foxglove\032\013Color.p"
  "roto\032\014Point3.proto\032\nPose.proto\"\257\002\n\rLineP"
  "rimitive\022*\n\004type\030\001 \001(\0162\034.foxglove.LinePr"
  "imitive.Type\022\034\n\004pose\030\002 \001(\0132\016.foxglove.Po"
  "se\022\021\n\tthickness\030\003 \001(\001\022\027\n\017scale_invariant"
  "\030\004 \001(\010\022 \n\006points\030\005 \003(\0132\020.foxglove.Point3"
  "\022\036\n\005color\030\006 \001(\0132\017.foxglove.Color\022\037\n\006colo"
  "rs\030\007 \003(\0132\017.foxglove.Color\022\017\n\007indices\030\010 \003"
  "(\007\"4\n\004Type\022\016\n\nLINE_STRIP\020\000\022\r\n\tLINE_LOOP\020"
  "\001\022\r\n\tLINE_LIST\020\002b\006proto3"
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_LinePrimitive_2eproto_deps[3] = {
  &::descriptor_table_Color_2eproto,
  &::descriptor_table_Point3_2eproto,
  &::descriptor_table_Pose_2eproto,
};
static ::_pbi::once_flag descriptor_table_LinePrimitive_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_LinePrimitive_2eproto = {
    false, false, 384, descriptor_table_protodef_LinePrimitive_2eproto,
    "LinePrimitive.proto",
    &descriptor_table_LinePrimitive_2eproto_once, descriptor_table_LinePrimitive_2eproto_deps, 3, 1,
    schemas, file_default_instances, TableStruct_LinePrimitive_2eproto::offsets,
    file_level_metadata_LinePrimitive_2eproto, file_level_enum_descriptors_LinePrimitive_2eproto,
    file_level_service_descriptors_LinePrimitive_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_LinePrimitive_2eproto_getter() {
  return &descriptor_table_LinePrimitive_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_LinePrimitive_2eproto(&descriptor_table_LinePrimitive_2eproto);
namespace foxglove {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* LinePrimitive_Type_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_LinePrimitive_2eproto);
  return file_level_enum_descriptors_LinePrimitive_2eproto[0];
}
...
::PROTOBUF_NAMESPACE_ID::Metadata LinePrimitive::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_LinePrimitive_2eproto_getter, &descriptor_table_LinePrimitive_2eproto_once,
      file_level_metadata_LinePrimitive_2eproto[0]);
}
