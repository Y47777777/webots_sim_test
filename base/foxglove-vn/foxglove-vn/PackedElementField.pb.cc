...
#include "PackedElementField.pb.h"
...
static ::_pb::Metadata file_level_metadata_PackedElementField_2eproto[1];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_PackedElementField_2eproto[1];
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_PackedElementField_2eproto = nullptr;

const uint32_t TableStruct_PackedElementField_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_PackedElementField_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\030PackedElementField.proto\022\010foxglove\"\343\001\n"
  "\022PackedElementField\022\014\n\004name\030\001 \001(\t\022\016\n\006off"
  "set\030\002 \001(\007\0226\n\004type\030\003 \001(\0162(.foxglove.Packe"
  "dElementField.NumericType\"w\n\013NumericType"
  "\022\013\n\007UNKNOWN\020\000\022\t\n\005UINT8\020\001\022\010\n\004INT8\020\002\022\n\n\006UI"
  "NT16\020\003\022\t\n\005INT16\020\004\022\n\n\006UINT32\020\005\022\t\n\005INT32\020\006"
  "\022\013\n\007FLOAT32\020\007\022\013\n\007FLOAT64\020\010b\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_PackedElementField_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_PackedElementField_2eproto = {
    false, false, 274, descriptor_table_protodef_PackedElementField_2eproto,
    "PackedElementField.proto",
    &descriptor_table_PackedElementField_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_PackedElementField_2eproto::offsets,
    file_level_metadata_PackedElementField_2eproto, file_level_enum_descriptors_PackedElementField_2eproto,
    file_level_service_descriptors_PackedElementField_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_PackedElementField_2eproto_getter() {
  return &descriptor_table_PackedElementField_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_PackedElementField_2eproto(&descriptor_table_PackedElementField_2eproto);
namespace foxglove {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* PackedElementField_NumericType_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_PackedElementField_2eproto);
  return file_level_enum_descriptors_PackedElementField_2eproto[0];
}
...
::PROTOBUF_NAMESPACE_ID::Metadata PackedElementField::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_PackedElementField_2eproto_getter, &descriptor_table_PackedElementField_2eproto_once,
      file_level_metadata_PackedElementField_2eproto[0]);
}
