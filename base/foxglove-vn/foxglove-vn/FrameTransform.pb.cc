...
static ::_pb::Metadata file_level_metadata_FrameTransform_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_FrameTransform_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_FrameTransform_2eproto = nullptr;

const uint32_t TableStruct_FrameTransform_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_FrameTransform_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\024FrameTransform.proto\022\010foxglove\032\020Quater"
  "nion.proto\032\rVector3.proto\032\037google/protob"
  "uf/timestamp.proto\"\300\001\n\016FrameTransform\022-\n"
  "\ttimestamp\030\001 \001(\0132\032.google.protobuf.Times"
  "tamp\022\027\n\017parent_frame_id\030\002 \001(\t\022\026\n\016child_f"
  "rame_id\030\003 \001(\t\022&\n\013translation\030\004 \001(\0132\021.fox"
  "glove.Vector3\022&\n\010rotation\030\005 \001(\0132\024.foxglo"
  "ve.Quaternionb\006proto3"
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_FrameTransform_2eproto_deps[3] = {
  &::descriptor_table_Quaternion_2eproto,
  &::descriptor_table_Vector3_2eproto,
  &::descriptor_table_google_2fprotobuf_2ftimestamp_2eproto,
};
static ::_pbi::once_flag descriptor_table_FrameTransform_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_FrameTransform_2eproto = {
    false, false, 301, descriptor_table_protodef_FrameTransform_2eproto,
    "FrameTransform.proto",
    &descriptor_table_FrameTransform_2eproto_once, descriptor_table_FrameTransform_2eproto_deps, 3, 1,
    schemas, file_default_instances, TableStruct_FrameTransform_2eproto::offsets,
    file_level_metadata_FrameTransform_2eproto, file_level_enum_descriptors_FrameTransform_2eproto,
    file_level_service_descriptors_FrameTransform_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_FrameTransform_2eproto_getter() {
  return &descriptor_table_FrameTransform_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_FrameTransform_2eproto(&descriptor_table_FrameTransform_2eproto);
namespace foxglove {
...
::PROTOBUF_NAMESPACE_ID::Metadata FrameTransform::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_FrameTransform_2eproto_getter, &descriptor_table_FrameTransform_2eproto_once,
      file_level_metadata_FrameTransform_2eproto[0]);
}
