...
static ::_pb::Metadata file_level_metadata_GeoJSON_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_GeoJSON_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_GeoJSON_2eproto = nullptr;

const uint32_t TableStruct_GeoJSON_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_GeoJSON_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\rGeoJSON.proto\022\010foxglove\"\032\n\007GeoJSON\022\017\n\007"
  "geojson\030\001 \001(\tb\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_GeoJSON_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_GeoJSON_2eproto = {
    false, false, 61, descriptor_table_protodef_GeoJSON_2eproto,
    "GeoJSON.proto",
    &descriptor_table_GeoJSON_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_GeoJSON_2eproto::offsets,
    file_level_metadata_GeoJSON_2eproto, file_level_enum_descriptors_GeoJSON_2eproto,
    file_level_service_descriptors_GeoJSON_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_GeoJSON_2eproto_getter() {
  return &descriptor_table_GeoJSON_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_GeoJSON_2eproto(&descriptor_table_GeoJSON_2eproto);
namespace foxglove {
...
::PROTOBUF_NAMESPACE_ID::Metadata GeoJSON::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_GeoJSON_2eproto_getter, &descriptor_table_GeoJSON_2eproto_once,
      file_level_metadata_GeoJSON_2eproto[0]);
}
