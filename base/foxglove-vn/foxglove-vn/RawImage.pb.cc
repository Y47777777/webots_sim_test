...
static ::_pb::Metadata file_level_metadata_RawImage_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_RawImage_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_RawImage_2eproto = nullptr;

const uint32_t TableStruct_RawImage_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_RawImage_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\016RawImage.proto\022\010foxglove\032\037google/proto"
  "buf/timestamp.proto\"\230\001\n\010RawImage\022-\n\ttime"
  "stamp\030\001 \001(\0132\032.google.protobuf.Timestamp\022"
  "\020\n\010frame_id\030\007 \001(\t\022\r\n\005width\030\002 \001(\007\022\016\n\006heig"
  "ht\030\003 \001(\007\022\020\n\010encoding\030\004 \001(\t\022\014\n\004step\030\005 \001(\007"
  "\022\014\n\004data\030\006 \001(\014b\006proto3"
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_RawImage_2eproto_deps[1] = {
  &::descriptor_table_google_2fprotobuf_2ftimestamp_2eproto,
};
static ::_pbi::once_flag descriptor_table_RawImage_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_RawImage_2eproto = {
    false, false, 222, descriptor_table_protodef_RawImage_2eproto,
    "RawImage.proto",
    &descriptor_table_RawImage_2eproto_once, descriptor_table_RawImage_2eproto_deps, 1, 1,
    schemas, file_default_instances, TableStruct_RawImage_2eproto::offsets,
    file_level_metadata_RawImage_2eproto, file_level_enum_descriptors_RawImage_2eproto,
    file_level_service_descriptors_RawImage_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_RawImage_2eproto_getter() {
  return &descriptor_table_RawImage_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_RawImage_2eproto(&descriptor_table_RawImage_2eproto);
namespace foxglove {
...
::PROTOBUF_NAMESPACE_ID::Metadata RawImage::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_RawImage_2eproto_getter, &descriptor_table_RawImage_2eproto_once,
      file_level_metadata_RawImage_2eproto[0]);
}
