...
static ::_pb::Metadata file_level_metadata_PosesInFrame_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_PosesInFrame_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_PosesInFrame_2eproto = nullptr;

const uint32_t TableStruct_PosesInFrame_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_PosesInFrame_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\022PosesInFrame.proto\022\010foxglove\032\nPose.pro"
  "to\032\037google/protobuf/timestamp.proto\"n\n\014P"
  "osesInFrame\022-\n\ttimestamp\030\001 \001(\0132\032.google."
  "protobuf.Timestamp\022\020\n\010frame_id\030\002 \001(\t\022\035\n\005"
  "poses\030\003 \003(\0132\016.foxglove.Poseb\006proto3"
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_PosesInFrame_2eproto_deps[2] = {
  &::descriptor_table_Pose_2eproto,
  &::descriptor_table_google_2fprotobuf_2ftimestamp_2eproto,
};
static ::_pbi::once_flag descriptor_table_PosesInFrame_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_PosesInFrame_2eproto = {
    false, false, 195, descriptor_table_protodef_PosesInFrame_2eproto,
    "PosesInFrame.proto",
    &descriptor_table_PosesInFrame_2eproto_once, descriptor_table_PosesInFrame_2eproto_deps, 2, 1,
    schemas, file_default_instances, TableStruct_PosesInFrame_2eproto::offsets,
    file_level_metadata_PosesInFrame_2eproto, file_level_enum_descriptors_PosesInFrame_2eproto,
    file_level_service_descriptors_PosesInFrame_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_PosesInFrame_2eproto_getter() {
  return &descriptor_table_PosesInFrame_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_PosesInFrame_2eproto(&descriptor_table_PosesInFrame_2eproto);
namespace foxglove {
...
::PROTOBUF_NAMESPACE_ID::Metadata PosesInFrame::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_PosesInFrame_2eproto_getter, &descriptor_table_PosesInFrame_2eproto_once,
      file_level_metadata_PosesInFrame_2eproto[0]);
}
