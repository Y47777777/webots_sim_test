...
static ::_pb::Metadata file_level_metadata_PoseInFrame_2eproto[2];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_PoseInFrame_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_PoseInFrame_2eproto = nullptr;

const uint32_t TableStruct_PoseInFrame_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::foxglove::Odometry, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::foxglove::Odometry, _impl_.timestamp_),
  PROTOBUF_FIELD_OFFSET(::foxglove::Odometry, _impl_.uuid_),
  PROTOBUF_FIELD_OFFSET(::foxglove::Odometry, _impl_.pose_),
  PROTOBUF_FIELD_OFFSET(::foxglove::Odometry, _impl_.wheelbase_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::foxglove::PoseInFrame)},
  { 9, -1, -1, sizeof(::foxglove::Odometry)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::foxglove::_PoseInFrame_default_instance_._instance,
  &::foxglove::_Odometry_default_instance_._instance,
};

const char descriptor_table_protodef_PoseInFrame_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\021PoseInFrame.proto\022\010foxglove\032\nPose.prot"
  "o\032\037google/protobuf/timestamp.proto\"l\n\013Po"
  "seInFrame\022-\n\ttimestamp\030\001 \001(\0132\032.google.pr"
  "otobuf.Timestamp\022\020\n\010frame_id\030\002 \001(\t\022\034\n\004po"
  "se\030\003 \001(\0132\016.foxglove.Pose\"x\n\010Odometry\022-\n\t"
  "timestamp\030\001 \001(\0132\032.google.protobuf.Timest"
  "amp\022\014\n\004uuid\030\002 \001(\t\022\034\n\004pose\030\003 \001(\0132\016.foxglo"
  "ve.Pose\022\021\n\twheelbase\030\004 \001(\001b\006proto3"
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_PoseInFrame_2eproto_deps[2] = {
  &::descriptor_table_Pose_2eproto,
  &::descriptor_table_google_2fprotobuf_2ftimestamp_2eproto,
};
static ::_pbi::once_flag descriptor_table_PoseInFrame_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_PoseInFrame_2eproto = {
    false, false, 314, descriptor_table_protodef_PoseInFrame_2eproto,
    "PoseInFrame.proto",
    &descriptor_table_PoseInFrame_2eproto_once, descriptor_table_PoseInFrame_2eproto_deps, 2, 2,
    schemas, file_default_instances, TableStruct_PoseInFrame_2eproto::offsets,
    file_level_metadata_PoseInFrame_2eproto, file_level_enum_descriptors_PoseInFrame_2eproto,
    file_level_service_descriptors_PoseInFrame_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_PoseInFrame_2eproto_getter() {
  return &descriptor_table_PoseInFrame_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_PoseInFrame_2eproto(&descriptor_table_PoseInFrame_2eproto);
namespace foxglove {
...
::PROTOBUF_NAMESPACE_ID::Metadata PoseInFrame::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_PoseInFrame_2eproto_getter, &descriptor_table_PoseInFrame_2eproto_once,
      file_level_metadata_PoseInFrame_2eproto[0]);
}
...
class Odometry::_Internal {
 public:
  static const ::PROTOBUF_NAMESPACE_ID::Timestamp& timestamp(const Odometry* msg);
  static const ::foxglove::Pose& pose(const Odometry* msg);
};

const ::PROTOBUF_NAMESPACE_ID::Timestamp&
Odometry::_Internal::timestamp(const Odometry* msg) {
  return *msg->_impl_.timestamp_;
}
const ::foxglove::Pose&
...
Odometry::Odometry(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:foxglove.Odometry)
}
Odometry::Odometry(const Odometry& from)
  ...
  // @@protoc_insertion_point(copy_constructor:foxglove.Odometry)
}
...
Odometry::~Odometry() {
  // @@protoc_insertion_point(destructor:foxglove.Odometry)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
void Odometry::Clear() {
// @@protoc_insertion_point(message_clear_start:foxglove.Odometry)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "foxglove.Odometry.uuid"));
        } else
          goto handle_unusual;
        continue;
      // .foxglove.Pose pose = 3;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 33)) {
          _impl_.wheelbase_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr);
          ptr += sizeof(double);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Odometry::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:foxglove.Odometry)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  double tmp_wheelbase = this->_internal_wheelbase();
  uint64_t raw_wheelbase;
  memcpy(&raw_wheelbase, &tmp_wheelbase, sizeof(tmp_wheelbase));
  if (raw_wheelbase != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(4, this->_internal_wheelbase(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:foxglove.Odometry)
  return target;
}

size_t Odometry::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:foxglove.Odometry)
  size_t total_size = 0;
...
void Odometry::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:foxglove.Odometry)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  static_assert(sizeof(uint64_t) == sizeof(double), "Code assumes uint64_t and double are the same size.");
  double tmp_wheelbase = from._internal_wheelbase();
  uint64_t raw_wheelbase;
  memcpy(&raw_wheelbase, &tmp_wheelbase, sizeof(tmp_wheelbase));
  if (raw_wheelbase != 0) {
...
// @@protoc_insertion_point(class_specific_copy_from_start:foxglove.Odometry)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void Odometry::InternalSwap(Odometry* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Odometry, _impl_.wheelbase_)
      + sizeof(Odometry::_impl_.wheelbase_)
...
::PROTOBUF_NAMESPACE_ID::Metadata Odometry::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_PoseInFrame_2eproto_getter, &descriptor_table_PoseInFrame_2eproto_once,
      file_level_metadata_PoseInFrame_2eproto[1]);
}
...
template<> PROTOBUF_NOINLINE ::foxglove::Odometry*
Arena::CreateMaybeMessage< ::foxglove::Odometry >(Arena* arena) {
  return Arena::CreateMessageInternal< ::foxglove::Odometry >(arena);
}
