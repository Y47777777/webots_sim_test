...
static ::_pb::Metadata file_level_metadata_CameraCalibration_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_CameraCalibration_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_CameraCalibration_2eproto = nullptr;

const uint32_t TableStruct_CameraCalibration_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_CameraCalibration_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\027CameraCalibration.proto\022\010foxglove\032\037goo"
  "gle/protobuf/timestamp.proto\"\271\001\n\021CameraC"
  "alibration\022-\n\ttimestamp\030\001 \001(\0132\032.google.p"
  "rotobuf.Timestamp\022\020\n\010frame_id\030\t \001(\t\022\r\n\005w"
  "idth\030\002 \001(\007\022\016\n\006height\030\003 \001(\007\022\030\n\020distortion"
  "_model\030\004 \001(\t\022\t\n\001D\030\005 \003(\001\022\t\n\001K\030\006 \003(\001\022\t\n\001R\030"
  "\007 \003(\001\022\t\n\001P\030\010 \003(\001b\006proto3"
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_CameraCalibration_2eproto_deps[1] = {
  &::descriptor_table_google_2fprotobuf_2ftimestamp_2eproto,
};
static ::_pbi::once_flag descriptor_table_CameraCalibration_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_CameraCalibration_2eproto = {
    false, false, 264, descriptor_table_protodef_CameraCalibration_2eproto,
    "CameraCalibration.proto",
    &descriptor_table_CameraCalibration_2eproto_once, descriptor_table_CameraCalibration_2eproto_deps, 1, 1,
    schemas, file_default_instances, TableStruct_CameraCalibration_2eproto::offsets,
    file_level_metadata_CameraCalibration_2eproto, file_level_enum_descriptors_CameraCalibration_2eproto,
    file_level_service_descriptors_CameraCalibration_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_CameraCalibration_2eproto_getter() {
  return &descriptor_table_CameraCalibration_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_CameraCalibration_2eproto(&descriptor_table_CameraCalibration_2eproto);
namespace foxglove {
...
::PROTOBUF_NAMESPACE_ID::Metadata CameraCalibration::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_CameraCalibration_2eproto_getter, &descriptor_table_CameraCalibration_2eproto_once,
      file_level_metadata_CameraCalibration_2eproto[0]);
}
