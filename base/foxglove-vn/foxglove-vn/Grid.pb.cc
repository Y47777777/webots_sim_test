...
static ::_pb::Metadata file_level_metadata_Grid_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_Grid_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_Grid_2eproto = nullptr;

const uint32_t TableStruct_Grid_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_Grid_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\nGrid.proto\022\010foxglove\032\030PackedElementFie"
  "ld.proto\032\nPose.proto\032\rVector2.proto\032\037goo"
  "gle/protobuf/timestamp.proto\"\206\002\n\004Grid\022-\n"
  "\ttimestamp\030\001 \001(\0132\032.google.protobuf.Times"
  "tamp\022\020\n\010frame_id\030\002 \001(\t\022\034\n\004pose\030\003 \001(\0132\016.f"
  "oxglove.Pose\022\024\n\014column_count\030\004 \001(\007\022$\n\tce"
  "ll_size\030\005 \001(\0132\021.foxglove.Vector2\022\022\n\nrow_"
  "stride\030\006 \001(\007\022\023\n\013cell_stride\030\007 \001(\007\022,\n\006fie"
  "lds\030\010 \003(\0132\034.foxglove.PackedElementField\022"
  "\014\n\004data\030\t \001(\014b\006proto3"
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_Grid_2eproto_deps[4] = {
  &::descriptor_table_PackedElementField_2eproto,
  &::descriptor_table_Pose_2eproto,
  &::descriptor_table_Vector2_2eproto,
  &::descriptor_table_google_2fprotobuf_2ftimestamp_2eproto,
};
static ::_pbi::once_flag descriptor_table_Grid_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_Grid_2eproto = {
    false, false, 381, descriptor_table_protodef_Grid_2eproto,
    "Grid.proto",
    &descriptor_table_Grid_2eproto_once, descriptor_table_Grid_2eproto_deps, 4, 1,
    schemas, file_default_instances, TableStruct_Grid_2eproto::offsets,
    file_level_metadata_Grid_2eproto, file_level_enum_descriptors_Grid_2eproto,
    file_level_service_descriptors_Grid_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_Grid_2eproto_getter() {
  return &descriptor_table_Grid_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_Grid_2eproto(&descriptor_table_Grid_2eproto);
namespace foxglove {
...
::PROTOBUF_NAMESPACE_ID::Metadata Grid::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Grid_2eproto_getter, &descriptor_table_Grid_2eproto_once,
      file_level_metadata_Grid_2eproto[0]);
}
