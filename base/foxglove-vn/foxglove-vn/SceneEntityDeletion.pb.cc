...
#include "SceneEntityDeletion.pb.h"
...
static ::_pb::Metadata file_level_metadata_SceneEntityDeletion_2eproto[1];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_SceneEntityDeletion_2eproto[1];
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_SceneEntityDeletion_2eproto = nullptr;

const uint32_t TableStruct_SceneEntityDeletion_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_SceneEntityDeletion_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\031SceneEntityDeletion.proto\022\010foxglove\032\037g"
  "oogle/protobuf/timestamp.proto\"\244\001\n\023Scene"
  "EntityDeletion\022-\n\ttimestamp\030\001 \001(\0132\032.goog"
  "le.protobuf.Timestamp\0220\n\004type\030\002 \001(\0162\".fo"
  "xglove.SceneEntityDeletion.Type\022\n\n\002id\030\003 "
  "\001(\t\" \n\004Type\022\017\n\013MATCHING_ID\020\000\022\007\n\003ALL\020\001b\006p"
  "roto3"
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_SceneEntityDeletion_2eproto_deps[1] = {
  &::descriptor_table_google_2fprotobuf_2ftimestamp_2eproto,
};
static ::_pbi::once_flag descriptor_table_SceneEntityDeletion_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_SceneEntityDeletion_2eproto = {
    false, false, 245, descriptor_table_protodef_SceneEntityDeletion_2eproto,
    "SceneEntityDeletion.proto",
    &descriptor_table_SceneEntityDeletion_2eproto_once, descriptor_table_SceneEntityDeletion_2eproto_deps, 1, 1,
    schemas, file_default_instances, TableStruct_SceneEntityDeletion_2eproto::offsets,
    file_level_metadata_SceneEntityDeletion_2eproto, file_level_enum_descriptors_SceneEntityDeletion_2eproto,
    file_level_service_descriptors_SceneEntityDeletion_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_SceneEntityDeletion_2eproto_getter() {
  return &descriptor_table_SceneEntityDeletion_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_SceneEntityDeletion_2eproto(&descriptor_table_SceneEntityDeletion_2eproto);
namespace foxglove {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* SceneEntityDeletion_Type_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_SceneEntityDeletion_2eproto);
  return file_level_enum_descriptors_SceneEntityDeletion_2eproto[0];
}
...
::PROTOBUF_NAMESPACE_ID::Metadata SceneEntityDeletion::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_SceneEntityDeletion_2eproto_getter, &descriptor_table_SceneEntityDeletion_2eproto_once,
      file_level_metadata_SceneEntityDeletion_2eproto[0]);
}
