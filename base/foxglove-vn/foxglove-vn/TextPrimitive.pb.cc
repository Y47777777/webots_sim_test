...
static ::_pb::Metadata file_level_metadata_TextPrimitive_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_TextPrimitive_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_TextPrimitive_2eproto = nullptr;

const uint32_t TableStruct_TextPrimitive_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_TextPrimitive_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\023TextPrimitive.proto\022\010foxglove\032\013Color.p"
  "roto\032\nPose.proto\"\232\001\n\rTextPrimitive\022\034\n\004po"
  "se\030\001 \001(\0132\016.foxglove.Pose\022\021\n\tbillboard\030\002 "
  "\001(\010\022\021\n\tfont_size\030\003 \001(\001\022\027\n\017scale_invarian"
  "t\030\004 \001(\010\022\036\n\005color\030\005 \001(\0132\017.foxglove.Color\022"
  "\014\n\004text\030\006 \001(\tb\006proto3"
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_TextPrimitive_2eproto_deps[2] = {
  &::descriptor_table_Color_2eproto,
  &::descriptor_table_Pose_2eproto,
};
static ::_pbi::once_flag descriptor_table_TextPrimitive_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_TextPrimitive_2eproto = {
    false, false, 221, descriptor_table_protodef_TextPrimitive_2eproto,
    "TextPrimitive.proto",
    &descriptor_table_TextPrimitive_2eproto_once, descriptor_table_TextPrimitive_2eproto_deps, 2, 1,
    schemas, file_default_instances, TableStruct_TextPrimitive_2eproto::offsets,
    file_level_metadata_TextPrimitive_2eproto, file_level_enum_descriptors_TextPrimitive_2eproto,
    file_level_service_descriptors_TextPrimitive_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_TextPrimitive_2eproto_getter() {
  return &descriptor_table_TextPrimitive_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_TextPrimitive_2eproto(&descriptor_table_TextPrimitive_2eproto);
namespace foxglove {
...
::PROTOBUF_NAMESPACE_ID::Metadata TextPrimitive::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_TextPrimitive_2eproto_getter, &descriptor_table_TextPrimitive_2eproto_once,
      file_level_metadata_TextPrimitive_2eproto[0]);
}
