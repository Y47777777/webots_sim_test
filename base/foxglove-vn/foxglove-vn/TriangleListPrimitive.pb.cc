...
#include "TriangleListPrimitive.pb.h"
...
static ::_pb::Metadata file_level_metadata_TriangleListPrimitive_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_TriangleListPrimitive_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_TriangleListPrimitive_2eproto = nullptr;

const uint32_t TableStruct_TriangleListPrimitive_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_TriangleListPrimitive_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\033TriangleListPrimitive.proto\022\010foxglove\032"
  "\013Color.proto\032\014Point3.proto\032\nPose.proto\"\251"
  "\001\n\025TriangleListPrimitive\022\034\n\004pose\030\001 \001(\0132\016"
  ".foxglove.Pose\022 \n\006points\030\002 \003(\0132\020.foxglov"
  "e.Point3\022\036\n\005color\030\003 \001(\0132\017.foxglove.Color"
  "\022\037\n\006colors\030\004 \003(\0132\017.foxglove.Color\022\017\n\007ind"
  "ices\030\005 \003(\007b\006proto3"
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_TriangleListPrimitive_2eproto_deps[3] = {
  &::descriptor_table_Color_2eproto,
  &::descriptor_table_Point3_2eproto,
  &::descriptor_table_Pose_2eproto,
};
static ::_pbi::once_flag descriptor_table_TriangleListPrimitive_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_TriangleListPrimitive_2eproto = {
    false, false, 258, descriptor_table_protodef_TriangleListPrimitive_2eproto,
    "TriangleListPrimitive.proto",
    &descriptor_table_TriangleListPrimitive_2eproto_once, descriptor_table_TriangleListPrimitive_2eproto_deps, 3, 1,
    schemas, file_default_instances, TableStruct_TriangleListPrimitive_2eproto::offsets,
    file_level_metadata_TriangleListPrimitive_2eproto, file_level_enum_descriptors_TriangleListPrimitive_2eproto,
    file_level_service_descriptors_TriangleListPrimitive_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_TriangleListPrimitive_2eproto_getter() {
  return &descriptor_table_TriangleListPrimitive_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_TriangleListPrimitive_2eproto(&descriptor_table_TriangleListPrimitive_2eproto);
namespace foxglove {
...
::PROTOBUF_NAMESPACE_ID::Metadata TriangleListPrimitive::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_TriangleListPrimitive_2eproto_getter, &descriptor_table_TriangleListPrimitive_2eproto_once,
      file_level_metadata_TriangleListPrimitive_2eproto[0]);
}
