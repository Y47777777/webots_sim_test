...
static ::_pb::Metadata file_level_metadata_CircleAnnotation_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_CircleAnnotation_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_CircleAnnotation_2eproto = nullptr;

const uint32_t TableStruct_CircleAnnotation_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_CircleAnnotation_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\026CircleAnnotation.proto\022\010foxglove\032\013Colo"
  "r.proto\032\014Point2.proto\032\037google/protobuf/t"
  "imestamp.proto\"\327\001\n\020CircleAnnotation\022-\n\tt"
  "imestamp\030\001 \001(\0132\032.google.protobuf.Timesta"
  "mp\022\"\n\010position\030\002 \001(\0132\020.foxglove.Point2\022\020"
  "\n\010diameter\030\003 \001(\001\022\021\n\tthickness\030\004 \001(\001\022#\n\nf"
  "ill_color\030\005 \001(\0132\017.foxglove.Color\022&\n\routl"
  "ine_color\030\006 \001(\0132\017.foxglove.Colorb\006proto3"
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_CircleAnnotation_2eproto_deps[3] = {
  &::descriptor_table_Color_2eproto,
  &::descriptor_table_Point2_2eproto,
  &::descriptor_table_google_2fprotobuf_2ftimestamp_2eproto,
};
static ::_pbi::once_flag descriptor_table_CircleAnnotation_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_CircleAnnotation_2eproto = {
    false, false, 320, descriptor_table_protodef_CircleAnnotation_2eproto,
    "CircleAnnotation.proto",
    &descriptor_table_CircleAnnotation_2eproto_once, descriptor_table_CircleAnnotation_2eproto_deps, 3, 1,
    schemas, file_default_instances, TableStruct_CircleAnnotation_2eproto::offsets,
    file_level_metadata_CircleAnnotation_2eproto, file_level_enum_descriptors_CircleAnnotation_2eproto,
    file_level_service_descriptors_CircleAnnotation_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_CircleAnnotation_2eproto_getter() {
  return &descriptor_table_CircleAnnotation_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_CircleAnnotation_2eproto(&descriptor_table_CircleAnnotation_2eproto);
namespace foxglove {
...
::PROTOBUF_NAMESPACE_ID::Metadata CircleAnnotation::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_CircleAnnotation_2eproto_getter, &descriptor_table_CircleAnnotation_2eproto_once,
      file_level_metadata_CircleAnnotation_2eproto[0]);
}
