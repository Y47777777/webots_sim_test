...
static ::_pb::Metadata file_level_metadata_LocationFix_2eproto[1];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_LocationFix_2eproto[1];
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_LocationFix_2eproto = nullptr;

const uint32_t TableStruct_LocationFix_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_LocationFix_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\021LocationFix.proto\022\010foxglove\"\211\002\n\013Locati"
  "onFix\022\020\n\010latitude\030\001 \001(\001\022\021\n\tlongitude\030\002 \001"
  "(\001\022\020\n\010altitude\030\003 \001(\001\022\033\n\023position_covaria"
  "nce\030\004 \003(\001\022N\n\030position_covariance_type\030\005 "
  "\001(\0162,.foxglove.LocationFix.PositionCovar"
  "ianceType\"V\n\026PositionCovarianceType\022\013\n\007U"
  "NKNOWN\020\000\022\020\n\014APPROXIMATED\020\001\022\022\n\016DIAGONAL_K"
  "NOWN\020\002\022\t\n\005KNOWN\020\003b\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_LocationFix_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_LocationFix_2eproto = {
    false, false, 305, descriptor_table_protodef_LocationFix_2eproto,
    "LocationFix.proto",
    &descriptor_table_LocationFix_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_LocationFix_2eproto::offsets,
    file_level_metadata_LocationFix_2eproto, file_level_enum_descriptors_LocationFix_2eproto,
    file_level_service_descriptors_LocationFix_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_LocationFix_2eproto_getter() {
  return &descriptor_table_LocationFix_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_LocationFix_2eproto(&descriptor_table_LocationFix_2eproto);
namespace foxglove {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* LocationFix_PositionCovarianceType_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_LocationFix_2eproto);
  return file_level_enum_descriptors_LocationFix_2eproto[0];
}
...
::PROTOBUF_NAMESPACE_ID::Metadata LocationFix::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_LocationFix_2eproto_getter, &descriptor_table_LocationFix_2eproto_once,
      file_level_metadata_LocationFix_2eproto[0]);
}
