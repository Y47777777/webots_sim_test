...
static ::_pb::Metadata file_level_metadata_Color_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_Color_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_Color_2eproto = nullptr;

const uint32_t TableStruct_Color_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
