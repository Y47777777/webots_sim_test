...
static ::_pb::Metadata file_level_metadata_ModelPrimitive_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_ModelPrimitive_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_ModelPrimitive_2eproto = nullptr;

const uint32_t TableStruct_ModelPrimitive_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_ModelPrimitive_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\024ModelPrimitive.proto\022\010foxglove\032\013Color."
  "proto\032\nPose.proto\032\rVector3.proto\"\267\001\n\016Mod"
  "elPrimitive\022\034\n\004pose\030\001 \001(\0132\016.foxglove.Pos"
  "e\022 \n\005scale\030\002 \001(\0132\021.foxglove.Vector3\022\036\n\005c"
  "olor\030\003 \001(\0132\017.foxglove.Color\022\026\n\016override_"
  "color\030\004 \001(\010\022\013\n\003url\030\005 \001(\t\022\022\n\nmedia_type\030\006"
  " \001(\t\022\014\n\004data\030\007 \001(\014b\006proto3"
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_ModelPrimitive_2eproto_deps[3] = {
  &::descriptor_table_Color_2eproto,
  &::descriptor_table_Pose_2eproto,
  &::descriptor_table_Vector3_2eproto,
};
static ::_pbi::once_flag descriptor_table_ModelPrimitive_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_ModelPrimitive_2eproto = {
    false, false, 266, descriptor_table_protodef_ModelPrimitive_2eproto,
    "ModelPrimitive.proto",
    &descriptor_table_ModelPrimitive_2eproto_once, descriptor_table_ModelPrimitive_2eproto_deps, 3, 1,
    schemas, file_default_instances, TableStruct_ModelPrimitive_2eproto::offsets,
    file_level_metadata_ModelPrimitive_2eproto, file_level_enum_descriptors_ModelPrimitive_2eproto,
    file_level_service_descriptors_ModelPrimitive_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_ModelPrimitive_2eproto_getter() {
  return &descriptor_table_ModelPrimitive_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_ModelPrimitive_2eproto(&descriptor_table_ModelPrimitive_2eproto);
namespace foxglove {
...
::PROTOBUF_NAMESPACE_ID::Metadata ModelPrimitive::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_ModelPrimitive_2eproto_getter, &descriptor_table_ModelPrimitive_2eproto_once,
      file_level_metadata_ModelPrimitive_2eproto[0]);
}
