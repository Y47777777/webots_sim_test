...
class AcuratorModel {
 ...
 public:
  virtual void config(const std::vector<struct SpecialParam> &param,
                      int start_p, int length = -1, bool is32bits = false) = 0;
};
...
class ForkDeviceZ : public CommonParsedValueModel {
 private:
  std::map<std::string, double> extra_val_;
...
class ForkDeviceP : public CommonParsedValueModel {
 public:
  ForkDeviceP();
  ~ForkDeviceP();
  virtual void config(const std::vector<struct SpecialParam> &param,
...
class ForkDisplacementSencerZ : public CommonParsedSencerModel {
 private:
  std::map<std::string, double> extra_val_;

 public:
  ForkDisplacementSencerZ();
  ~ForkDisplacementSencerZ();
  virtual void solveValue(const std::vector<double> &input,
                          std::vector<double> &output) override;
  virtual void config(const std::vector<struct SpecialParam> &param, int last,
...
class AccelerometerX : public CommonParsedSencerModel {
 private:
  std::map<std::string, double> extra_val_;
...
class AccelerometerY : public CommonParsedSencerModel {
 private:
  std::map<std::string, double> extra_val_;
...
class AccelerometerZ : public CommonParsedSencerModel {
 private:
  std::map<std::string, double> extra_val_;
...
class AngularVelocitySensorX : public CommonParsedSencerModel {
 private:
  std::map<std::string, double> extra_val_;

 public:
  AngularVelocitySensorX();
  ~AngularVelocitySensorX();
  virtual void config(const std::vector<struct SpecialParam> &param, int last,
                      int length = -1, bool is32bits = false,
                      bool isSigned = false);
...
class AngularVelocitySensorY : public CommonParsedSencerModel {
 private:
  std::map<std::string, double> extra_val_;

 public:
  AngularVelocitySensorY();
  ~AngularVelocitySensorY();
  virtual void config(const std::vector<struct SpecialParam> &param, int last,
                      int length = -1, bool is32bits = false,
                      bool isSigned = false);
...
class AngularVelocitySensorZ : public CommonParsedSencerModel {
 private:
  std::map<std::string, double> extra_val_;

 public:
  AngularVelocitySensorZ();
  ~AngularVelocitySensorZ();
  virtual void config(const std::vector<struct SpecialParam> &param, int last,
                      int length = -1, bool is32bits = false,
                      bool isSigned = false);
